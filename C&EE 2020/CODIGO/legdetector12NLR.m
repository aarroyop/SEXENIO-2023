...
%         end;        
  ...
  XP(:,1)=data3(:,1);  XP(:,2)=data3(:,2);   XP(:,3)=data3(:,3);   XP(:,4)=data3(:,4);  XP(:,5)=data3(:,5);    
 XP(:,6)=data3(:,6);   XP(:,7)=data3(:,8);   XP(:,8)=data3(:,9);   
  
  end;
  if (i==8)
      
 XP(:,1)=data3(:,1);  XP(:,2)=data3(:,2);   XP(:,3)=data3(:,3);   XP(:,4)=data3(:,4);  XP(:,5)=data3(:,5);    
 XP(:,6)=data3(:,6);   XP(:,7)=data3(:,7);   XP(:,8)=data3(:,9);  
  end;
  for(h=1:3358)
...
filename='resultados12legdetectorRNLR.xlsx'; %solo se hace la regresión con el tramo1 y se estima en función de esas primeras filas con normalización
...
% xlswrite(filename,y3RBF(1:3358,2),'imputacion','B3');
 xlswrite(filename,y3RNOlineal(1:3358,1),'imputacion','A3');
 xlswrite(filename,y3RNOlineal(1:3358,2),'imputacion','B3');
