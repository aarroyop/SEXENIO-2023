...
%filename = '80tr1.xlsx';
 ...
 A = {'Time RBF','MSE Mean','MSE STD','Neurons', 'T med R','STD R' ;tocCreateRB,TmedMSER,TsSMER,hiddenLayerSizeP,TmedR,STDmedR};
...
% C = {'Time R Lineal','MSE Mean','MSE STD';tocRLinealmed,MedRLineal,ssmeRLineal};
...
% D = {'Time R NO Lineal','MSE','STD';tocRNOlinealmed,MedRnoLineal,ssmeRNOLineal};
