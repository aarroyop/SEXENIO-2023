...
filename='resultados12legdetector.xlsx'; % se hace la regresión con el tramo1+TRAMO3-tramo2 y se estima en función de todas esas filas con normalización

xlswrite(filename,tocCreateRBF,'RBF', 'A2');
xlswrite(filename,performanceRBF,'RBF','A4');
xlswrite(filename,tocRBFtrain,'RBF','A19');

xlswrite(filename,y3RBF(1:3357,1),'imputacion','A3');
xlswrite(filename,y3RBF(1:3357,2),'imputacion','B3');
xlswrite(filename,y3RNOlineal(1:3357,1),'imputacion','D3');
xlswrite(filename,y3RNOlineal(1:3357,2),'imputacion','E3');
xlswrite(filename,y3Rlineal(1:3357,1),'imputacion','G3');
xlswrite(filename,y3Rlineal(1:3357,2),'imputacion','H3');
% 
